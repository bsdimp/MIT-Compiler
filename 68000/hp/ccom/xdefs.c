...
short strflg;  /* if on, strings are to be treated as lists *//* MFM */

short reached;	/* true if statement can be reached... *//* MFM */
...
short cflag = 0;  /* do we check for funny casts */	/* MFM */
short hflag = 0;  /* do we check for various heuristics which may indicate errors */	/* MFM */
short pflag = 0;  /* do we check for portable constructions */	/* MFM */
