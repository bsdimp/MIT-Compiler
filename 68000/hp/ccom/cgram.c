...
extern short yychar;			/* MFM */
extern short yyerrflag;			/* MFM */
#ifndef YYMAXDEPTH
...
short yydebug = 0; /* 1 for debugging */
YYSTYPE yyv[YYMAXDEPTH]; /* where the values are stored */
short yychar = -1; /* current input token number */	/* MFM */
short yynerrs = 0;  /* number of errors */		/* MFM */
short yyerrflag = 0;  /* error recovery flag */		/* MFM */

yyparse() {

	short yys[YYMAXDEPTH];
	register short yyj, yym;			/* MFM */
 ...
 yystack:    /* put a state and value onto the stack */
	...
	if( yydebug  ) printf( "state %d, char 0%x\n", yystate, yychar );
