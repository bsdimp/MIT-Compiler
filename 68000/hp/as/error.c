...
/* 42 */	"Bad csect",
/* 43 */	"Odd address",
/* 44 */	"Relocation error above this line",
/* 45 */	"Invalid arithmetic operator for a relocatable operand",
/* 46 */	".align in text segment. Avoid sdi's through/across it.",
/* 47 */	"Invalid register list",
		0
} ;

int Errors;		/* Number of errors in this pass */
...
int code;
{
	...
	if (Errors++ > MAXERR) abort();		/* increment error count */
	fprintf(stderr,"as: error (%d): %s\n",Line_no,E_messages[code]);
}
